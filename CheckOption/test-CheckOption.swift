...
for loop in testConditionDataSet {
  ...
  if returnSet.flag[0] != loop.result.upper {
    print("\u{001B}[0;37;41m => NG\u{001B}[0;30m")
    print(returnSet)
  } else if returnSet.flag[1] != loop.result.lower {
    print("\u{001B}[0;37;41m => NG\u{001B}[0;30m")
    print(returnSet)
  } else if returnSet.flag[2] != loop.result.number {
    print("\u{001B}[0;37;41m => NG\u{001B}[0;30m")
    print(returnSet)
  } else if returnSet.flag[3] != loop.result.symbol {
    print("\u{001B}[0;37;41m => NG\u{001B}[0;30m")
    print(returnSet)
